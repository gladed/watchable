...
| [io.gladed.watchable.util.Cannot](../io.gladed.watchable.util/-cannot/index.md) | Something cannot be done. |
...
| [io.gladed.watchable.util.Try](../io.gladed.watchable.util/-try/index.md) | The result of a suspending attempt to do something that might not be possible (e.g. could throw [Cannot](../io.gladed.watchable.util/-cannot/index.md)). |
