...
| [io.gladed.watchable.DeferredWatcher](../io.gladed.watchable/-deferred-watcher/index.md) | Exposes a [deferred](#) as a [Watcher](../io.gladed.watchable/-watcher/index.md). |
...
| [io.gladed.watchable.store.MultiHold](../io.gladed.watchable.store/-multi-hold/index.md) | A deferred attempt to acquire an instance of [T](../io.gladed.watchable.store/-multi-hold/index.md#T) on behalf of one or more holding entities, starting with [entity](#). |
